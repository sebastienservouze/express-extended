...
export abstract class Controllers {
    ...
    public static use(app: Application, controllerType: Type<any>[]): void {
        controllerType.forEach((type) => Controllers.register(app, type));
    }

    private static register(app: Application, controllerType: Type<any>): void {
        ...
        const instance = Container.resolve(controllerType);
